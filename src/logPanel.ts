...
export class LogManager extends Panel {
  ...
  onlogin(data: any) {
    ...
    this.servicesConsole.displayLogs(this.consoles);
    let deletFilterMenuItem = document.getElementById(
      "delete-filtere-menu-item"
    );
    if (deletFilterMenuItem != undefined) {
      deletFilterMenuItem.style.display = "block";
    }

    let deleteAllDataMenuItem = document.getElementById(
      "delete-all-data-menu-item"
    );
    if (deletFilterMenuItem != undefined) {
      deleteAllDataMenuItem.style.display = "block";
    }
  }
