...
class ServiceDescriptorPanel extends Panel {
    ...
    constructor(descriptor: ServiceDescriptor) {
        // Set the panel id.
        super("service_description_panel_" + descriptor.getPublisherid() + "_" + descriptor.getId() + "_" + descriptor.getVersion())

        // Display general information.
        this.installBtn = this.div.appendElement({ "tag": "div", "class": "row service_descriptor_panel" }).down()
            ...
            .appendElement({ "tag": "span", "class": "card-title", "style": "font-size: 1.5em;", "innerHtml": descriptor.getId() })
            .appendElement({ "tag": "div", "id": "content" })
            // The action buttons.
            .appendElement({ "tag": "div", "class": "card-action row", "id": "btn_group", "style": "text-align: right; display: none; align-items: baseline;" }).down()
            .appendElement({ "tag": "div", "class": "input-field col s4 offset-s6" }).down()
            .appendElement({ "tag": "input", "id": this.id + "_install_id_input", "placeholder": "id", "type": "text" })
            .appendElement({ "tag": "label", "for": this.id + "_install_id_input" }).up()
            .appendElement({ "tag": "a", "id": this.id + "_install_btn", "href": "javascript:void(0)", "class": "waves-effect waves-light btn disabled col s2", "innerHtml": "Install" }).down()
        ...
        this.content.appendElement({ "tag": "div", "class": "row" }).down()
            .appendElement({ "tag": "div", "class": "col s12 m6", "style": "height: 100%", "innerHtml": "Publisher" })
            .appendElement({ "tag": "div", "id": "publisher_div", "class": "col s12 m6", "innerHtml": descriptor.getPublisherid() }).down()

        this.content.appendElement({ "tag": "div", "class": "row" }).down()
            .appendElement({ "tag": "div", "class": "col s12 m6", "style": "height: 100%", "innerHtml": "Version" })
            .appendElement({ "tag": "div", "id": "publisher_div", "class": "col s12 m6", "innerHtml": descriptor.getVersion() }).down()

        this.content.appendElement({ "tag": "div", "class": "row" }).down()
            .appendElement({ "tag": "div", "class": "col s12 m6", "style": "height: 100%", "innerHtml": "Description" })
            .appendElement({ "tag": "div", "id": "publisher_div", "class": "col s12 m6", "innerHtml": descriptor.getDescription() }).down()
        ...
        this.idInput.element.onkeyup = (evt:any)=>{
            ...
            if(evt.keyCode == 13){
                ...
                installService(descriptor.getDiscoveriesList()[0], descriptor.getId(), descriptor.getPublisherid(), descriptor.getVersion(), ()=>{
                    console.log("---> eva!")
                })
            }
        }
